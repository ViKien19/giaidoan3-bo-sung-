...
<head>
    ...
    <style>
        ...
        .register-container:hover .planet-icon {
            color: #ffffff;
    ...
    <div class="container">
        <div class="register-container">
            <h2 class="register-title">
                <i class="fas fa-planet-ringed planet-icon"></i>Đăng Ký
            </h2>
            ...
            <p class="text-center mt-3">Đã có tài khoản? <a href="{{ route('login') }}">Đăng nhập ngay</a></p>
        </div>
    </div>
